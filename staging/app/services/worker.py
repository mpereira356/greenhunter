...
def follow_alerts(session):
    ...
    for alert in active_alerts:
        ...
        if exact_target:
            ...
            if exact_stage == "HT" and not is_half_time_text(stats_payload.get("time_text", "")):
                already_past_half = is_second_half(stats_payload.get("time_text", ""), minute) or _is_confirmed_full_time(stats_payload.get("time_text", ""))
